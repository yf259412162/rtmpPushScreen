...
Java_com_example_rtmp_RtmpClient_getIpAddr(JNIEnv *env, jclass type, jlong rtmpPointer) {
    if (rtmpPointer != 0) {
...
Java_com_example_rtmp_RtmpClient_close(JNIEnv *env, jclass type, jlong rtmpPointer) {
    LOGD("start close");
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_example_rtmp_RtmpClient_write(JNIEnv *env, jclass type_, jlong rtmpPointer,
...
Java_com_example_rtmp_RtmpClient_open(JNIEnv *env, jclass type, jstring url_,
